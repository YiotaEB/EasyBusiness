...
public class ViewCustomers_SelectProductsAsyncTask extends AsyncTask<Void,Void,Void> {
    ...
    public ViewCustomers_SelectProductsAsyncTask(String query, Activity activity, View view) {
        this.query = query;
        ...
        try {
            ...
            if (statusCode == HttpURLConnection.HTTP_OK) {
                ...
                if (status.equals(AsyncTasks.RESPONSE_OK)) {
                    ...
                    final ListView productsListview = activity.findViewById(R.id.product_list);
