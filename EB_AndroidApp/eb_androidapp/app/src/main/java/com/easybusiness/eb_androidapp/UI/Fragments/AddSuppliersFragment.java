...
public class AddSuppliersFragment extends Fragment {
    ...
    private Button add_supplies_Btn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        add_supplies_Btn = v.findViewById(R.id.add_employees_Btn);
        ...
        productsSpinner = v.findViewById(R.id.products_spinner);
        ...
        add_employees_Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkInput()) {
                    ...
                    new AddEmployeesFragment.AddEmployeeAsyncTask(
                            getActivity(),
                            view,
    ...
    private void getRequiredFields() {
        new AddEmployeesFragment.GetCountriesAsyncTask("", getActivity(), v).execute();
